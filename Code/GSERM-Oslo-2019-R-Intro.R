...
#
# File last updated December 29, 2018
###############################################
#
# Basics: OBJECTS
#
...
PSUWVB * 100 # <- from proportions to percentages
...
setwd("~/Dropbox (Personal)/GSERM/Materials - Oslo 2019/Data")
...
url <- getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-Oslo-2019-git/master/Data/SCOTUS-votes.csv")
...
# 
# Because R is a programming language, it is
# possible to automate tasks using loops and
# other control structures. The basic structure
# of a loop in R is:
#
#  for (i in 1:N) {
#     <<activity>>
